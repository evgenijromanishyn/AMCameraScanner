...
class VideoFeed {
    ...
    func setup(
        ...
        objectsDelegate: AVCaptureMetadataOutputObjectsDelegate,
        ...
        sessionQueue.async {
            self.configureSession(
                ...
                objectsDelegate: objectsDelegate,
    ...
    func configureSession(
        ...
        do {
            ...
            if (session.canAddOutput(metadataOutput)) {
                ...
                metadataOutput.setMetadataObjectsDelegate(objectsDelegate, queue: DispatchQueue.main)
